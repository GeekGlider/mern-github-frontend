  ...
  return (
    <li className='mb-10 ms-7'>
        ...
        <div className='flex gap-2 items-center flex-wrap'>
            ...
            <span onClick={()=>handleCloneClick(repo)} className='cursor-pointer bg-green-100 text-green-800 text-xs
        ...
        { Programming_Language[repo.language] ?
         ( <img src={Programming_Language[repo.language]}  alt='Programming language icon' className='h-8' />) : null }
    </li>
  )
}
