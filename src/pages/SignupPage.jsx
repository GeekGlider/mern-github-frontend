...
function SignupPage() {
  const handleLoginwithGithub = () =>{
    window.open("https://mern-github-backend.onrender.com/api/auth/github", "_self");
  }
  return (
    <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0'>
      <div className='w-full rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 bg-glass'>
       <div className='p-6 spacey-y-4 md:space-y-6 sm:p-8'>
        ...
        <p className='text-gray-300'>By signing up, you will unlock all the features of the app.</p>
        <p className='text-sm font-light text-gray-500'>
        Already have an account?{" "}
          <Link to="/login" className='font-medium text-primary-600 hover:underline text-blue-600'>Login</Link>
        </p>
       </div>
      </div>
    </div>
